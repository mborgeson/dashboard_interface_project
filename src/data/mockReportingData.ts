...
export const mockDistributionSchedules: DistributionSchedule[] = [
  {
    ...
    templateId: 'exec-summary',
    templateName: 'Executive Summary',
    recipients: ['ceo@brcapital.com', 'cfo@brcapital.com', 'coo@brcapital.com'],
    frequency: 'weekly',
    dayOfWeek: 1, // Monday
    time: '08:00',
    format: 'pdf',
  ...
  },
  {
    ...
    templateId: 'financial-performance',
    templateName: 'Financial Performance Report',
    recipients: ['finance@brcapital.com', 'accounting@brcapital.com'],
    frequency: 'monthly',
    dayOfMonth: 5,
    time: '09:00',
    format: 'excel',
  ...
  },
  {
    ...
    templateId: 'quarterly-investor',
    templateName: 'Quarterly Investor Report',
    recipients: ['investors@brcapital.com', 'ir@brcapital.com'],
    frequency: 'quarterly',
    dayOfMonth: 15,
    time: '10:00',
    format: 'pdf',
  ...
  },
  {
    ...
    templateId: 'portfolio-overview',
    templateName: 'Portfolio Overview',
    recipients: ['asset-management@brcapital.com'],
    frequency: 'daily',
    time: '07:00',
    format: 'pdf',
    isActive: false,
