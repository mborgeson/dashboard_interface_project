...
class GraphAPIFileExtractor:
    ...
    def __init__(
        ...
        self.client_secret = client_secret or secure_config.get_credential(
            "AZURE_CLIENT_SECRET"
        )
        ...
        logger.info(
            "graph_api_extractor_initialized",
    ...
    def authenticate(self) -> bool:
        ...
        try:
            ...
            logger.info(
                "graph_api_authentication_successful",
    ...
    def _make_graph_request(
        self, endpoint: str, method: str = "GET", stream: bool = False, **kwargs
    ) -> requests.Response:
    ...
    def get_site_info(
        self, site_url: str = "bandrcapital.sharepoint.com:/sites/BRCapital-Internal"
    ) -> Dict[str, str]:
    ...
    def get_drive_info(
        self, site_id: str, drive_name: str = "Real Estate"
    ) -> Dict[str, str]:
    ...
    def discover_uw_files(self, site_id: str, drive_id: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            search_endpoint = (
                f"/sites/{site_id}/drives/{drive_id}/root/search(q='{search_query}')"
            )
            ...
            for item in search_results.get("value", []):
                ...
                if (
                    "Templates" in file_path
                    or "template" in file_path.lower()
                    or "/Temp" in file_path
                    or file_path == ""
                    or ("UW Model" in file_path and "Deals" not in file_path)
                ):
                    filtered_out_count += 1
                    continue
            ...
            logger.info(
                "uw_files_discovered_with_filtering",
    ...
    def extract_from_file_info(
        self, file_info: Dict[str, Any], extractor: ExcelDataExtractor
        ...
        try:
            ...
            file_buffer = self.stream_file_content(
                file_info["site_id"], file_info["drive_id"], file_id
            )
