...
VALIDATION_RULES: list[ValidationRule] = [
    ValidationRule(
        name="cap_rate",
        field_patterns=["cap_rate", "caprate", "cap_rt", "return_on"],
        min_value=0.0,
        max_value=0.25,
        warning_min=0.02,
        warning_max=0.15,
        is_percentage=False,
        description="Cap rate as decimal fraction (0-25%, warn outside 2-15%)",
    ),
    ValidationRule(
        name="purchase_price",
    ...
    ValidationRule(
        ...
        warning_max=1.0,
        is_percentage=False,
        description="Occupancy as decimal fraction (0-100%, warn below 50%)",
    ),
    ValidationRule(
        name="vacancy_rate",
        field_patterns=["vacancy"],
        min_value=0.0,
        max_value=1.0,
        warning_min=0.0,
        warning_max=0.15,
        is_percentage=False,
        description="Vacancy rate as decimal fraction (0-100%, warn above 15%)",
    ),
    ValidationRule(
        name="square_footage",
        field_patterns=[
