...
class SourceTrackingMixin:
    ...
    source_file_path: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        comment="Full SharePoint/file path to source"
    )
    source_file_modified_at: Mapped[Optional[datetime]] = mapped_column(
    ...
    extraction_version: Mapped[Optional[str]] = mapped_column(
        String(50),
        nullable=True,
        comment="Version of extraction script used"
    )
    ...
    extraction_errors: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        comment="Any errors during extraction"
    )
