...
class NOIAssumptions(Base, TimestampMixin, SourceTrackingMixin):
    ...
    market_rent_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
    ...
    in_place_rent_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
    ...
    rent_growth_year_1: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
        comment="Year 1 rent growth rate"
    )
    rent_growth_year_2: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
        comment="Year 2 rent growth rate"
    )
    rent_growth_year_3: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
        comment="Year 3 rent growth rate"
    )
    rent_growth_year_4: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
        comment="Year 4 rent growth rate"
    )
    rent_growth_year_5: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
    ...
    physical_vacancy_pct: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
        comment="Physical vacancy rate"
    )
    economic_vacancy_pct: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
        comment="Economic vacancy rate"
    )
    bad_debt_pct: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
        comment="Bad debt / collection loss percentage"
    )
    concessions_pct: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
        comment="Concessions percentage"
    )
    model_vacancy_pct: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
        comment="Model unit vacancy percentage"
    )
    employee_unit_pct: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
    ...
    # Other Income
    other_income_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Other income per unit per year"
    )
    utility_reimbursement_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Utility reimbursement per unit per year"
    )
    parking_income_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Parking income per unit per year"
    )
    pet_income_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Pet income per unit per year"
    )
    late_fee_income_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Late fee income per unit per year"
    )
    application_fee_income_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Application fee income per unit per year"
    )
    other_income_growth_rate: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
    ...
    administrative_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Administrative expense per unit per year"
    )
    marketing_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Marketing expense per unit per year"
    )
    professional_fees_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
    ...
    # Payroll Expenses
    payroll_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Total payroll expense per unit per year"
    )
    management_salary_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Management salary per unit per year"
    )
    maintenance_salary_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Maintenance salary per unit per year"
    )
    payroll_taxes_benefits_pct: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
    ...
    # Utilities
    utilities_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Total utilities per unit per year"
    )
    electricity_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Electricity per unit per year"
    )
    gas_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Gas per unit per year"
    )
    water_sewer_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Water/sewer per unit per year"
    )
    trash_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
    ...
    # Repairs & Maintenance
    repairs_maintenance_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="R&M per unit per year"
    )
    contract_services_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Contract services per unit per year"
    )
    make_ready_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Make-ready/turnover cost per unit per year"
    )
    landscaping_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
    ...
    # Insurance & Taxes
    insurance_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Insurance per unit per year"
    )
    real_estate_taxes_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Real estate taxes per unit per year"
    )
    tax_reassessment_pct: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
    ...
    asset_management_fee_pct: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
    ...
    # Expense Growth
    expense_growth_rate: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
        comment="Annual expense growth rate"
    )
    insurance_growth_rate: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
        comment="Annual insurance growth rate"
    )
    tax_growth_rate: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
        comment="Annual property tax growth rate"
    )
    utility_growth_rate: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
    ...
    replacement_reserves_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Replacement reserves per unit per year"
    )
    capital_reserve_pct: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
    ...
    # Per Unit Metrics
    total_revenue_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Total revenue per unit per year"
    )
    total_expenses_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
    ...
    break_even_occupancy: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(6, 4),
        nullable=True,
    ...
    t12_gpr: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(15, 2),
        nullable=True,
        comment="T-12 Gross Potential Rent"
    )
    t12_vacancy_loss: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(15, 2),
        nullable=True,
        comment="T-12 Vacancy Loss"
    )
    t12_concessions: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(15, 2),
        nullable=True,
        comment="T-12 Concessions"
    )
    t12_bad_debt: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(15, 2),
        nullable=True,
        comment="T-12 Bad Debt"
    )
    t12_other_income: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(15, 2),
        nullable=True,
        comment="T-12 Other Income"
    )
    t12_egi: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(15, 2),
        nullable=True,
        comment="T-12 Effective Gross Income"
    )
    t12_total_expenses: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(15, 2),
        nullable=True,
    ...
    renovation_rent_premium_per_unit: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(10, 2),
        nullable=True,
        comment="Expected rent premium per renovated unit"
    )
    renovation_lease_up_months: Mapped[Optional[int]] = mapped_column(
        Integer,
        nullable=True,
    ...
    renovation_pace_per_month: Mapped[Optional[int]] = mapped_column(
        Integer,
        nullable=True,
