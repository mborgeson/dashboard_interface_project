...
class TestEmailServiceInit:
    ...
    def test_setup_templates_with_existing_directory(self):
        ...
        with patch('app.services.email_service.Path') as mock_path:
            ...
            mock_path.return_value.__truediv__.return_value.__truediv__.return_value = mock_path_instance
...
class TestTemplateRendering:
    ...
    def test_render_template_calls_get_template(self, email_service_with_templates):
        ...
        email_service_with_templates._template_env.get_template.assert_called_with("welcome.html")
    ...
    def test_render_template_passes_context(self, email_service_with_templates):
        ...
        email_service_with_templates._template_env.get_template().render.assert_called_with(**context)
...
class TestSendEmail:
    ...
    @pytest.mark.asyncio
    async def test_send_email_with_multiple_recipients(self, email_service, mock_settings):
    ...
    async def test_send_email_multiple_attachments(self, email_service, mock_settings):
        ...
        with patch('app.services.email_service.aiosmtplib.send', new_callable=AsyncMock) as mock_send:
            attachments = [
                {"filename": "file1.pdf", "content": b"PDF 1", "mime_type": "application/pdf"},
                {"filename": "file2.xlsx", "content": b"Excel data", "mime_type": "application/xlsx"},
            ]
            result = await email_service.send_email(
                to_email="recipient@test.com",
                subject="Test Subject",
    ...
    @pytest.mark.asyncio
    async def test_send_email_string_recipient_converted_to_list(self, email_service, mock_settings):
...
class TestWelcomeEmail:
    ...
    @pytest.mark.asyncio
    async def test_send_welcome_email_success(self, email_service_with_templates, mock_settings):
    ...
    @pytest.mark.asyncio
    async def test_send_welcome_email_uses_template(self, email_service_with_templates, mock_settings):
    ...
    @pytest.mark.asyncio
    async def test_send_welcome_email_fallback_on_template_error(self, email_service, mock_settings):
        """Test fallback welcome email when template fails."""
        email_service._template_env = MagicMock()
        email_service._template_env.get_template.side_effect = Exception("Template error")
...
class TestPasswordResetEmail:
    ...
    @pytest.mark.asyncio
    async def test_send_password_reset_email_success(self, email_service_with_templates, mock_settings):
    ...
    @pytest.mark.asyncio
    async def test_send_password_reset_email_custom_expiry(self, email_service_with_templates, mock_settings):
    ...
    @pytest.mark.asyncio
    async def test_send_password_reset_email_uses_template(self, email_service_with_templates, mock_settings):
        ...
        with patch('app.services.email_service.aiosmtplib.send', new_callable=AsyncMock):
            ...
            email_service_with_templates._template_env.get_template.assert_called_with("password_reset.html")

    @pytest.mark.asyncio
    async def test_send_password_reset_fallback_on_template_error(self, email_service, mock_settings):
...
class TestReportEmail:
    ...
    @pytest.mark.asyncio
    async def test_send_report_email_success(self, email_service_with_templates, mock_settings):
    ...
    @pytest.mark.asyncio
    async def test_send_report_email_multiple_recipients(self, email_service_with_templates, mock_settings):
    ...
    @pytest.mark.asyncio
    async def test_send_report_email_custom_mime_type(self, email_service_with_templates, mock_settings):
    ...
    @pytest.mark.asyncio
    async def test_send_report_email_fallback_on_template_error(self, email_service, mock_settings):
...
class TestDealNotificationEmail:
    ...
    @pytest.mark.asyncio
    async def test_send_deal_notification_success(self, email_service_with_templates, mock_settings):
    ...
    @pytest.mark.asyncio
    async def test_send_deal_notification_uses_template(self, email_service_with_templates, mock_settings):
        ...
        with patch('app.services.email_service.aiosmtplib.send', new_callable=AsyncMock):
            ...
            email_service_with_templates._template_env.get_template.assert_called_with("deal_notification.html")

    @pytest.mark.asyncio
    async def test_send_deal_notification_fallback_on_template_error(self, email_service, mock_settings):
